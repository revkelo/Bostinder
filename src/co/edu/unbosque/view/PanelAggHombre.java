...
/**
 * Panel que gestiona los parametros para agregar un usuario hombre y extiende
 * de JPanel
 * 
 * @author Daniela
 * @author Jose
...
public class PanelAggHombre extends JPanel {

	/**
	 * Atributo tipo JLabel que indica lo que debera ingresar el usuario
	 */
	private JLabel nombre, alias, edad, correo, estatura, ingresos, estadociv, contra, apellido1, apellido2, e1, e2, e3;
	/**
	 * Atributo tipo JTextField para que el usuario digite los requisitos que se le
	 * solicitan
	 */
	private JTextField tNombre, tAlias, tCorreo, tEstatura, tIngresos, tContra, tApellido1, tApellido2;
	/**
	 ...
	 */
	private JComboBox<String> dia, mes, anio, estado;
	/**
	...
	private void inicializarComponentes() {
		...
		guardar.setActionCommand("guardarHombre");
		...
		ingresos.setBounds(320, 150, 150, 50);
		ingresos.setFont(new Font("Monospaced", Font.BOLD, 15));
		...
		tIngresos.setBounds(320, 210, 250, 25);
		tIngresos.setFont(new Font("Monospaced", Font.BOLD, 20));
		add(tIngresos);
	 ...
	 * El metodo set funciona para actualizar el atributo
	 * 
	 * @param tIngresos the tIngresos to set
	 */
	public void settIngresos(JTextField tIngresos) {
